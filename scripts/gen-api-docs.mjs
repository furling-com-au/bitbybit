...
<meta name="description" content="A free, no-account API for creating group tools — sweeps, gift registries, meal trains, polls. One unauthenticated POST returns a share link and an organiser link.">
