# Printable Cup sweep sheet

Scissors edition

Print it, stick it on the fridge, cut the numbers into a hat. Or skip the scissors entirely — the [online version](https://bitibybit.com/melbourne-cup-sweep/) draws it in one minute and gives everyone a link.

## Melbourne Cup Sweep — first Tuesday in November
...
Entry: 
 ...
 Split — 1st: 2nd: 3rd: Last: 
 
 Scratchings rule (pick one now): refund / re-draw / bad luck

## How to run it

1. **Print the sheet** and write in the horse names once the final field is declared — that happens the Saturday before the race. If you're drawing early, leave the numbers and match them up on the day.
